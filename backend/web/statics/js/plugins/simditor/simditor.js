...
Simditor.i18n = {
  'zh-CN': {
    ...
    'image': '鎻掑叆鍥剧墖',
    'localImage': '鏈湴鍥剧墖',
    'externalImage': '澶栭摼鍥剧墖',
    'uploadImage': '涓婁紶鍥剧墖',
    'uploadFailed': '涓婁紶澶辫触浜�',
    'uploadError': '涓婁紶鍑洪敊浜�',
    'imageUrl': '鍥剧墖鍦板潃',
    'imageSize': '鍥剧墖灏哄',
    'restoreImageSize': '杩樺師鍥剧墖灏哄',
    'uploading': '姝ｅ湪涓婁紶',
    'indent': '鍚戝彸缂╄繘',
    'outdent': '鍚戝乏缂╄繘',
    'italic': '鏂滀綋鏂囧瓧',
    ...
    'ol': '鏈夊簭鍒楄〃',
    'ul': '鏃犲簭鍒楄〃',
    'strikethrough': '鍒犻櫎绾挎枃瀛�',
    'table': '琛ㄦ牸',
    'deleteRow': '鍒犻櫎琛�',
    'insertRowAbove': '鍦ㄤ笂闈㈡彃鍏ヨ',
    'insertRowBelow': '鍦ㄤ笅闈㈡彃鍏ヨ',
    'deleteColumn': '鍒犻櫎鍒�',
    'insertColumnLeft': '鍦ㄥ乏杈规彃鍏ュ垪',
    'insertColumnRight': '鍦ㄥ彸杈规彃鍏ュ垪',
    'deleteTable': '鍒犻櫎琛ㄦ牸',
    'title': '鏍囬',
    'normalText': '鏅€氭枃鏈�',
    'underline': '涓嬪垝绾挎枃瀛�'
...
TableButton = (function(_super) {
  ...
  TableButton.prototype.renderMenu = function() {
    $("<div class=\"menu-create-table\">\n</div>\n<div class=\"menu-edit-table\">\n  <ul>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" data-param=\"deleteRow\"><span>" + (this._t('deleteRow')) + " ( Ctrl + Alt + 鈫� )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" data-param=\"insertRowAbove\"><span>" + (this._t('insertRowAbove')) + " ( Ctrl + Alt + 鈫� )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" data-param=\"insertRowBelow\"><span>" + (this._t('insertRowBelow')) + " ( Ctrl + Alt + 鈫� )</span></a></li>\n    <li><span class=\"separator\"></span></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" data-param=\"deleteCol\"><span>" + (this._t('deleteColumn')) + "</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" data-param=\"insertColLeft\"><span>" + (this._t('insertColumnLeft')) + " ( Ctrl + Alt + 鈫� )</span></a></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" data-param=\"insertColRight\"><span>" + (this._t('insertColumnRight')) + " ( Ctrl + Alt + 鈫� )</span></a></li>\n    <li><span class=\"separator\"></span></li>\n    <li><a tabindex=\"-1\" unselectable=\"on\" class=\"menu-item\" href=\"javascript:;\" data-param=\"deleteTable\"><span>" + (this._t('deleteTable')) + "</span></a></li>\n  </ul>\n</div>").appendTo(this.menuWrapper);
